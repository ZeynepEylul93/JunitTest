...
//"We Offer" elementi görünür olacak şekilde üzerine scroll et ve ekran görüntüsünü al
        ...
        bekle(2);
        tumSayfaResmi();//-->testbase deki ScreenShot metodu
...
//Sayfayi en üste scroll yapalım
    ...
    public void test02() {
        ...
        driver.get("https://techproeducation.com");
        bekle(2);
        driver.findElement(By.xpath("//i[@class='eicon-close']")).click();//reklami kapat
        JavascriptExecutor js= (JavascriptExecutor) driver;
    ...
    //input tagi icine deger yazabildigimiz taglardir
