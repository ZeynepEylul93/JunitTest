...
Dropdown'i handle(automate) etmek icin;
    ...
    8--> Dropdown menüye sendKeys() metodu ile de ddmmenudeki seceneklerden birini kullanarak gonderebiliriz
 ...
 */
    ...
    public void test01() {
     ...
     //        a. Yil,ay,gün dropdown menu'leri locate ediniz
      ...
      //  yil.sendKeys("2021");-->boyle bir kullanimi da var
     ...
     //        b. Select objesi olustur
        ...
        Select select1 = new Select(ay);//july->option tagindaki value attribute degerini aldik
    ...
    public void test02() {
      ...
      //  select.getOptions().forEach(w-> System.out.println(w.getText()));-->lambda ile
        //getOptions() metodu ile tum secenekleri yazdirdik

        List<WebElement> eyaletlerList = driver.findElements(By.xpath("(//select)[5]"));
    ...
    public void test03() {
     //   a. State dropdownindaki varsayilan secili secenegin 'Select a State' oldugunu verify edelim
       ...
       // Assert.assertTrue(seciliOlanSecenek.contains("Select"));-->boylede olur
    }
