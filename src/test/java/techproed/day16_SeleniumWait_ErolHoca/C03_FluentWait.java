 ...
 */
    ...
    public void test01() {
       ...
       FluentWait<WebDriver> wait=new FluentWait<>(driver);
        wait.withTimeout(Duration.ofSeconds(20)).//FluentWait icin max. bekleme suresini verir
        pollingEvery(Duration.ofMillis(200)).//-->200milisaniye araliklarla webelementin etkilesime girdigini kontrol et
        withMessage("Webelementi kontrol et");//mesaj kismi zorunlu degil
