...
//        5.Sign in buttonuna tiklayin
       ...
       login.sendKeys("username", Keys.TAB,"password",Keys.ENTER);
                //input#user_login->css ile alirsak
        Thread.sleep(3000);
        driver.navigate().back();

//        6.online banking altında Pay Bills sayfasina gidin
        driver.findElement(By.xpath("(//*[text()=.])[11]")).click();
        //-->(//*[text()=.])[11]->Bu sekilde text ile aldigimiz bir xpath dinamiktir.Text degisse bile
...
//        7.amount kismina yatirmak istediginiz herhangi bir miktari yazin
      ...
      //->xpath=>  driver.findElement(By.xpath("//*[@id='sp_amount']")).sendKeys("100");
...
//        10.“The payment was successfully submitted.” mesajinin ciktigini control edin
        ...
        //2.yol-->Webelementin gorunur olup olmadigini dogrulamak icin yaptik
